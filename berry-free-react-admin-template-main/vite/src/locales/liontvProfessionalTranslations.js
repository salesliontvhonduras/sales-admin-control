export const lionTvProfessionalTranslations = {
  en: {
    ...
    m3uBackup: {
      ...
      line: 'Original line',
      linePlaceholder: 'Search line by name...',
      lineLocked: 'This alias is bound to the selected original line.',
      lineHelper: 'Search and select the real active line that provides the original provider credentials.',
      usernameEncode: 'Original line username',
      usernameEncodeHelper: 'This is the real line reference used behind the alias. Do not give it to the client.',
      aliasUsername: 'Customer username',
      aliasUsernameHelper: 'Xtream username delivered to the client.',
      ...
      playerApiUrl: 'player_api URL',
      playerApiHelper: 'Use this URL to test the Xtream alias. It must show alias credentials, not original line credentials.',
      copyXtreamCredentials: 'Copy Xtream data',
      copyPlayerApi: 'Copy player_api URL',
      previewTitle: 'M3U compatibility links',
      previewHelper: 'Use this URL only for IPTV players that still consume M3U by URL.',
      downloadHelper: 'Use this URL in a browser when you want the .m3u file to download directly.',
      messages: {
        missingPreview: 'Define customer username and password first.',
        xtreamCredentialsCopied: 'Xtream credentials copied.',
        playerApiCopied: 'player_api URL copied.',
        linkCopied: 'Player link copied.',
        downloadLinkCopied: 'Download link copied.',
        saved: 'Xtream alias saved successfully.'
      }
    },
    paymentCommitments: {
  ...
  es: {
    ...
    m3uBackup: {
      ...
      line: 'Línea original',
      linePlaceholder: 'Buscar línea por nombre...',
      lineLocked: 'Este alias queda ligado a la línea original seleccionada.',
      lineHelper: 'Busca y selecciona la línea real activa que aporta las credenciales originales del proveedor.',
      usernameEncode: 'Usuario original de la línea',
      usernameEncodeHelper: 'Esta es la referencia real que usa el alias por debajo. No se la entregues al cliente.',
      aliasUsername: 'Usuario cliente',
      aliasUsernameHelper: 'Usuario Xtream que se entrega al cliente.',
      ...
      xtreamUser: 'Usuario',
      xtreamPassword: 'Password',
      playerApiUrl: 'URL player_api',
      playerApiHelper: 'Usa esta URL para probar el alias Xtream. Debe mostrar credenciales alias, no credenciales originales de la línea.',
      copyXtreamCredentials: 'Copiar datos Xtream',
      copyPlayerApi: 'Copiar URL player_api',
      previewTitle: 'Links de compatibilidad M3U',
      previewHelper: 'Usa esta URL solo para players IPTV que todavía consumen M3U por URL.',
      downloadHelper: 'Usa esta URL en navegador cuando quieras descargar directamente el archivo .m3u.',
      messages: {
        missingPreview: 'Define primero usuario y password cliente.',
        xtreamCredentialsCopied: 'Credenciales Xtream copiadas.',
        playerApiCopied: 'URL player_api copiada.',
        linkCopied: 'Link de player copiado.',
        downloadLinkCopied: 'Link de descarga copiado.',
        saved: 'Alias Xtream guardado correctamente.'
      }
    },
    paymentCommitments: {
