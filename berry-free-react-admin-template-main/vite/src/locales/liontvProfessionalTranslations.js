  ...
  en: {
    ...
    subscriptions: {
      ...
      form: {
        ...
        linePlus: 'Line plus',
        linesPlusHint: 'Only LION_PLUS+ lines are shown here.',
        status: 'Status',
        ...
        noPlusLines: 'No LION_PLUS+ lines available',
        sections: {
          main: 'Main data',
  ...
  es: {
    ...
    subscriptions: {
      ...
      form: {
        ...
        linePlus: 'Línea plus',
        linesPlusHint: 'Aquí solo se muestran líneas LION_PLUS+.',
        status: 'Estado',
        ...
        noPlusLines: 'No hay líneas LION_PLUS+ disponibles',
        sections: {
